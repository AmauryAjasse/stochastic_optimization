...
if __name__ == '__main__':
    ...
    for i in range(len(p0_list)):
        ...
        temperature_2019 = read_data(horizon, os.path.join(os.getcwd(), 'meteo_data', 'temperature_24_days.csv'), usecols=[0, 1],
                              tz_data='Indian/Antananarivo')
        charge_2019 = read_data(horizon, os.path.join(os.getcwd(), 'microgrid_consumption', 'scenarios_24_days', '24_days_example_1.csv'), usecols=[0, 1],  tz_data='Indian/Antananarivo', date_format=None, sep=';')
